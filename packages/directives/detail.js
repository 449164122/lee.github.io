 ...
 * @LastEditors: 李韬
 * @LastEditTime: 2022-08-12 10:54:24
 */
export default {
  inserted: function(el) {
    el.addEventListener('dblclick', ()=>{
      ...
      if (detailDom) {
        ...
        detailDom.getElementsByTagName('div')[0].innerText = el.innerText;
        setTimeout(()=>{
        ...
        newElChild.style.cssText = "margin: auto";
        newElChild.innerText = el.innerText;
